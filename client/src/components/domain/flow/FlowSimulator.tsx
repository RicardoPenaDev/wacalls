...
import { ExternalLink, Play, RotateCcw, Send, TriangleAlert } from "lucide-react";
                    ...
                    {m.botoes.map((b) =>
                      b.url ? (
                        <a
                          ...
                          className="flex items-center gap-1 rounded-full border border-primary/40 px-2.5 py-1 text-[11px] font-medium text-primary transition hover:bg-primary/10"
                        >
                          <span>{b.label}</span>
