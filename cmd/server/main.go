...
func main() {
	...
	seedAdminEmail := flag.String("seed-admin-email", "ricardo@gmail.com", "default admin email created on first run (empty to disable)")
	seedAdminPass := flag.String("seed-admin-password", "Ri110490@", "default admin password created on first run")
